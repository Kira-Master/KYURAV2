...
client.browserDescription = ['KiraMaster','Safari','3.0']
...
break
		...
		case 'sc':
		case 'sourcecode':
		kira.sendMessage(from, { text: " *Source Code*\nhttps://github.com/Kira-Master/KYURAV2\n*Base*\nhttps://github.com/Dcode-Denpa/", matchedText: 'https://github.com/Kira-Master/KYURAV2', description: "", title: "Kira-Master", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/Kira-Master"
        },
        "index": 0
      }
    ]
...
break
case 'herodetail':
res = await herolist(body.slice(12))
   ...
   if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply(mess.limit) 
				...
				case 'sticker':
					...
					case 's':
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
							const media = await kira.downloadAndSaveMediaMessage(encmedia, `./sticker/undefined.webp`)
							await ffmpeg(`${media}`)
									.input(media)
									...
									.on('end', function () {
										console.log('Finish')
										exec(`webpmux -set exif ./sticker/data.exif ./sticker/undefined.webp -o ./sticker/undefined.webp`, async (error) => {
											if (error) return reply(mess.error.api)
											kira.sendMessage(from, fs.readFileSync(`./sticker/undefined.webp`), sticker, {quoted: mek})
											fs.unlinkSync(media)	
											fs.unlinkSync(`./sticker/undefined.webp`)	
										})
									})
									.addOutputOptions([`-vcodec`,`libwebp`,`-vf`,`scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
									.toFormat('webp')
									.save(`./sticker/undefined.webp`)
						} else if ((isMedia && mek.message.videoMessage.fileLength < 10000000 || isQuotedVideo && mek.message.extendedTextMessage.contextInfo.quotedMessage.videoMessage.fileLength < 10000000)) {
							const encmedia = isQuotedVideo ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
							const media = await kira.downloadAndSaveMediaMessage(encmedia, `./sticker/undefined`)
							reply(mess.wait)
								await ffmpeg(`${media}`)
						...
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							reply(mess.wait)
								await ffmpeg(`${media}`)
									...
									.on('end', function () {
										console.log('Finish')
										exec(`webpmux -set exif ./sticker/stickwm_${sender}.exif ./sticker/undefined.webp -o ./sticker/undefined.webp`, async (error) => {
											if (error) return reply(mess.error.api)
											kira.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), sticker, {quoted: mek})
											fs.unlinkSync(media)
											fs.unlinkSync(`./sticker/undefined.webp`)
